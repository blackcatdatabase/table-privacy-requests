...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'privacy_requests'; }
    public static function contractView(): string { return 'vw_privacy_requests'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'type', 'status', 'requested_at', 'processed_at', 'meta' ]; }
