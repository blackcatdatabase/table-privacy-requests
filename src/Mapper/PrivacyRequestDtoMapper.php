...
namespace BlackCat\Database\Packages\PrivacyRequests\Mapper;

use BlackCat\Database\Packages\PrivacyRequests\Dto\PrivacyRequestDto;
use BlackCat\Database\Packages\PrivacyRequests\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO PrivacyRequestDto:
...
final class PrivacyRequestDtoMapper
{
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'requested_at', 'processed_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): PrivacyRequestDto
    {
        /** @var PrivacyRequestDto */
        return DtoHydrator::fromRow(
            PrivacyRequestDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?PrivacyRequestDto
    {
     ...
     *
     * @param PrivacyRequestDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PrivacyRequestDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PrivacyRequestDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PrivacyRequestDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PrivacyRequestDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PrivacyRequestDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PrivacyRequestDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PrivacyRequestDto>
     */
