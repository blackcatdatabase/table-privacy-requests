...
final class PrivacyRequestsModule implements ModuleInterface
{
    public function name(): string { return 'table-privacy_requests'; }
    public function table(): string { return 'privacy_requests'; }
    ...
    public static function contractView(): string { return 'vw_privacy_requests'; }
