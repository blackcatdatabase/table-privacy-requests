...
use BlackCat\Database\Packages\PrivacyRequests\Repository\PrivacyRequestRepository;
...
{
    private PrivacyRequestRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PrivacyRequestRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PrivacyRequests\Dto\PrivacyRequestDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PrivacyRequests\Dto\PrivacyRequestDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PrivacyRequests\Dto\PrivacyRequestDto|null
    {
