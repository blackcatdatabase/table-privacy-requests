...
namespace BlackCat\Database\Packages\PrivacyRequests;
...
use BlackCat\Database\Packages\PrivacyRequests\Repository\PrivacyRequestRepository as GeneratedRepository;
...
{
  private PrivacyRequestRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PrivacyRequestRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PrivacyRequestRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PrivacyRequests\Dto\PrivacyRequestDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PrivacyRequests\Dto\PrivacyRequestDto|null { return $this->repo->getById($id, $asDto); }
