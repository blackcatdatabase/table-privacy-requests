...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'type', 'status', 'requested_at', 'processed_at', 'meta' ];
    }
...
{
    return [ 'id', 'user_id', 'type', 'status', 'requested_at', 'processed_at' ];
}
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\PrivacyRequests\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\PrivacyRequests\Definitions::softDeleteColumn();
