...
| Pkg folder | [packages\privacy-requests](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\privacy-requests) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package privacy-requests -Apply
