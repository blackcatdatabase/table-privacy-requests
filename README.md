...
- Pkg folder: [packages\privacy-requests](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\privacy-requests)
...
graph LR
  ...
  privacy_requests["privacy_requests"]:::center
  privacy_requests -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package privacy-requests -Apply
